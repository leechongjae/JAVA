...
//        int result1 = num1 + num2;		// 자동으로 큰 쪽 자료형인 long으로 변경 후 계산하기 때문에 int형 변수에 값을 담을 수 없다.
        ...
        System.out.println("result2: " + result2);	    // 정상 실행됨
         ...
         * */
//        long eight = 888888888888888888888;   // 이 숫자도 지동으로 형변환 된 것이다. (int 범위 벗어나면 에러 발생)
        long eight = 8;
        float four = eight;
        ...
        /* 설명. int로 type이 정해지지 않은 리터럴 형태의 정수는 char(문자)형 변수에 기록 가능하다. */
        char ch2 = 65;
