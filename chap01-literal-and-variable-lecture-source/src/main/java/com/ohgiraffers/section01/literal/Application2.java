...
public class Application2 {
    ...
    public static void main(String[] args) {
        ...
        /* 필기. 이 떄, 값의 형태에 따라 사용할 수 있는 연산자의 종류와 연산의 결과가 달라진다. */
        ...
        System.out.println(123 / 10);
        System.out.println(123 % 10);   // 여기서 %는 모듈러(modular) 연산이라고 부른다.
        ...
        /* 목차. 1-3. 정수와 실수의 연산 */
        /* 필기. 정수와 실수의 연산도 수학에서 사용하는 사칙 연산에 나머지를 구하는 연산(mod)을 사용할 수 있다. */
        ...
        * */
        ...
        /* 설명. 단, 결과는 실수 형태로 나오게 된다. (아까 위에서 했던 정수와 실수의 연산 결과를 생각해보자) */
