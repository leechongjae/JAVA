...
public class C_ifElseIf {
    ...
    public void testSimpleIfElseIfStatement() {
        ...
        * */
        ...
        /* 설명. 문자열 비교하는 equals()를 사용해 문자열로 입력을 받아도된다. */
        System.out.print("어느 도끼가 너의 도끼이냐? (1. 금도끼, 2. 은도끼, 3. 쇠도끼): ");

        Scanner sc = new Scanner(System.in);
        int answer = sc.nextInt();

        /* 설명. 대답한 내용이 금도끼인지 확인하는 조건식 */
        if(answer == 1) {

            /* 설명. 금도끼라고 대답한 경우 출력할 내용 */
            System.out.println("이런 거짓말 쟁이!! 너에게는 아무런 도끼도 줄 수 없구나!! 이 욕심쟁이야!!");

            /* 설명. 대답한 내용이 은도끼인지 확인하는 조건식 */
        } else if(answer == 2) {

            /* 설명. 은도끼라고 대답한 경우 출력할 내용 */
            System.out.println("욕심이 과하지는 않지만 그래도 넌 거짓말을 하고 있구나!! 어서 썩 사라지거라!!");

            /* 설명. 위에 제시한 금도끼, 은도끼가 둘 다 아닌 경우(즉, 쇠도끼인 경우) */
        } else {

            /* 설명. 쇠도끼라고 대답한 경우 출력할 내용 */
            System.out.println("오호~ 정직하구나~ 여기 있는 금도끼, 은도끼, 쇠도끼를 다 가져가거라!!");
        }

        System.out.println("그렇게 산신령은 다시 연목 속으로 사라지고 말았다...");   // 대답 여부와 상관 없이 마지막에 실행하는 내용
    }
    ...
    public void testNestedIfElseIfStatement() {
        ...
        * */
        ...
        if(point >= 90) {
            ...
            /* 설명. 등급은 A등급인데 그럼 +가 붙을 자격이 있는지(95점 이상인지) 다시 확인 */
            if(point >= 95) {

                /* 설명. 95점 이상인 경우 A등급에 +기호를 덧붙여 A+ 등급을 만들어준다. */
                grade += "+";
            }
        } else if(point >= 80) {

            /* 설명. 점수가 90점 미만, 80점 이상인 경우 */
            grade = "B";

            /* 설명. 등급은 B등급인데 그럼 +가 붙을 자격이 있는지(85점 이상인지) 다시 확인 */
            if(point >= 85) {

                /* 설명. 85점 이상인 경우 B등급에 +기호를 덧붙여 B+ 등급을 만들어준다. */
                grade += "+";
            }
        } else if(point >= 70) {

            /* 설명. 점수가 80점 미만, 70점 이상인 경우 */
            grade = "C";

            /* 설명. 등급은 C등급인데 그럼 +가 붙을 자격이 있는지(75점 이상인지) 다시 확인 */
            if(point >= 75) {

                /* 설명. 75점 이상인 경우 C등급에 +기호를 덧붙여 C+ 등급을 만들어준다. */
                grade += "+";
            }
        } else if(point >= 60) {

            /* 설명. 점수가 70점 미만, 60점 이상인 경우 */
            grade = "D";

            /* 설명. 등급은 D등급인데 그럼 +가 붙을 자격이 있는지(65점 이상인지) 다시 확인 */
            if(point >= 65) {

                /* 설명. 65점 이상인 경우 D등급에 +기호를 덧붙여 D+ 등급을 만들어준다. */
                grade += "+";
            }
        } else {

            /* 설명. 위 조건을 다 만족하지 못하는 점수가 60점 미만인 경우 */
            grade = "F";
    ...
    public void improveNestedIfElseIfStatement() {
        ...
        * */
        ...
        /* 설명. 각 등급의 중간 점수 이상이면서 60점 이상인 경우인지 확인(즉, +를 붙이는 조건에 맞는지 확인) */
