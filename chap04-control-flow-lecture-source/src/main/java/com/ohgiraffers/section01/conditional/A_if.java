...
public class A_if {
    ...
    public void testSimpleIfStatement() {
        ...
        * */
        ...
        /* 설명.
		 *  Scanner로 입력받은 정수가 짝수인지 물어보는 조건을 기술함:
		 *  어떤 수를 2로 나누었을 때 나머지가 0이면 짝수이다.
		 *  (즉, 2의 배수이다)
		* */
        if(num % 2 == 0) {

            /* 설명.
             *  조건식 부분에 작성한 내용이 true일 때는 아래 명령어를 실행한다.
             *  하지만, false인 경우 if블록 전체를 무시하고 건너뛰어 실행한다.
            * */
    ...
    public void testNestedIfStatement() {
        ...
        * */
        ...
        if(num > 0) {
            ...
            /* 설명. 만약 양수가 맞다면, 다시 한 번 더 짝수인지 조건을 확인함 */
            if(num % 2 == 0) {
