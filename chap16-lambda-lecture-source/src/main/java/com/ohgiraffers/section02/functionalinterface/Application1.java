...
public class Application1 {
	...
	public static void main(String[] args) {
		...
		/* Note. 원래 형태: Consumer<String> consumer = (str) -> { System.out.println(str + "이(가) 입력됨"); }; */
		/* Note. 매개변수가 하나인 경우, 소괄호를 생략할 수 있음. Application2에 매개변수가 2개 이상인 경우가 나옴. */
		...
		/* Note. 시간 없을 때 아래 IntConsumer와 LongConsumer 생략 가능. */
